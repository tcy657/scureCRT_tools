...
Sub Main()
  ...
  if check2_manu = "True" then
		 	...
		 	g_objTab.Screen.WaitForString "->"
    	g_objTab.Screen.Send  "copy " & chr(34) & send_dir_zz & send_manu & chr(34) & "," & chr(34) & "/tffs/" & send_manu & chr(34) & chr(13)
    	g_objTab.Screen.WaitForString "->"
  end if
            ...
            Case "check_manu"
             ...
             Case "check_dir"
                ...
                if g_objIE.Document.All("check_dir").Checked then
                 ...
                 g_objIE.Document.All("manu_filename").Value = g_objIE.Document.All("check_dir").Checked
