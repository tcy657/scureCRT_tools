...
'          "Cancel" from within the dialog.
    ...
    g_objIE.Document.Body.innerHTML = _
        ...
        "<!--*******Part3: Direction*check_manu************-->"  & _
        "<input name='check_dir' type='checkbox' onclick=""document.all('ButtonHandler').value='check_dir';"" AccessKey='c'><b>Location</b><br>" & _
        "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" & _
            "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;d<u>i</u>recion:&nbsp;<input name='dir_location' size='71' maxlength='512' AccessKey='i'><br>" & _
        "<!--*******Part4: Log to file*************-->"  & _
        "<input name='check_log' type='checkbox' onclick=""document.all('ButtonHandler').value='check_log';"" AccessKey='d'><b>Log output to file</b><br>" & _
        "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" & _
            "log &nbsp;fi<u>l</u>ename:&nbsp;<input name='LogFilename' size='71' maxlength='512' AccessKey='l'><br>" & _
        "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;" & _
            "<input type=radio name='LogMode' value='Append' AccessKey='A' checked><u>A</u>ppend" & _
        "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;" & _
...
'    g_objIE.width = 640
    ...
    g_objIE.Document.All("check_dir").Checked = check3_dir
    	g_objIE.Document.All("dir_location").Value = send_dir
    g_objIE.Document.All("check_log").Checked = check4_log
    	g_objIE.Document.All("LogFilename").Value = send_logfile
        ...
        Select Case g_objIE.Document.All("ButtonHandler").Value
            ...
            Case "OK"
                ...
                check3_dir   = g_objIE.Document.All("check_dir").Checked
                	send_dir   = g_objIE.Document.All("dir_location").Value
                check4_log   = g_objIE.Document.All("check_log").Checked
                	send_logfile  = g_objIE.Document.All("LogFilename").Value
            ...
            Case "check_dir"
                ...
                if g_objIE.Document.All("check_dir").Checked then
                    ' Enable the other elements of the dialog dealing with
                    ' logging
                    g_objIE.Document.All("dir_location").Disabled = False
                else
                    ' Disable the other elements of the dialog dealing with
                    ' logging
                    g_objIE.Document.All("dir_location").Disabled = True
                end if
