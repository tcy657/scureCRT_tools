...
'          "Cancel" from within the dialog.
    ...
    Do
        ...
        if   g_objIE.Document.All("send_cmd1").Checked  And _
             g_objIE.Document.All("send_cmd2").Checked  And _
             g_objIE.Document.All("send_cmd3").Checked  And _
             g_objIE.Document.All("send_cmd4").Checked  And _
             g_objIE.Document.All("send_cmd5").Checked  And _
             g_objIE.Document.All("send_cmd6").Checked  And _
             g_objIE.Document.All("send_cmd7").Checked  And _
             g_objIE.Document.All("send_cmd8").Checked  And _
             g_objIE.Document.All("send_cmd9").Checked  And _
             g_objIE.Document.All("send_cmd10").Checked And _
             g_objIE.Document.All("send_cmd11").Checked  then
      
               g_objIE.Document.All("check_all").Checked = True
         else
               g_objIE.Document.All("check_all").Checked = False
         end if  
