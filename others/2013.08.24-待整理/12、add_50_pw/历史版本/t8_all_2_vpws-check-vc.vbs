...
Function add_vpws_a1 
	...
	'check result
	'objCurrentTab.Screen.Send "show ldp mpls" & chr(13)
	'objCurrentTab.Screen.WaitForString "#"
...
Function check_vc_a1
	...
	'start to check	
	objCurrentTab.Screen.Send "!!!!!!!!!check a1" & chr(13)
	objCurrentTab.Screen.WaitForString "#"
	
	'vpws1
	objCurrentTab.Screen.Send "sh ldp mpls-l2-circuit 201" & chr(13)
	objCurrentTab.Screen.WaitForString "GE0/9/5.201UP"
	objCurrentTab.Screen.Send "sh ldp mpls-l2-circuit 202" & chr(13)
	objCurrentTab.Screen.WaitForString "GE0/9/5.201UP"
	
	'vpws2
	objCurrentTab.Screen.Send "sh ldp mpls-l2-circuit 203" & chr(13)
	objCurrentTab.Screen.WaitForString "GE0/9/5.203UP"
	objCurrentTab.Screen.Send "sh ldp mpls-l2-circuit 204" & chr(13)
	objCurrentTab.Screen.WaitForString "GE0/9/5.203UP"
...
Function check_vc_b1
	...
	'start to check	
	objCurrentTab.Screen.Send "!!!!!!!!!check b1" & chr(13)
	objCurrentTab.Screen.WaitForString "#"
	
	'vpws1
	objCurrentTab.Screen.Send "sh ldp mpls-l2-circuit 201" & chr(13)
	objCurrentTab.Screen.WaitForString "L2VE0/0/251UP"
	
	'vpws2
	objCurrentTab.Screen.Send "sh ldp mpls-l2-circuit 203" & chr(13)
	objCurrentTab.Screen.WaitForString "L2VE0/0/253UP"

	'return to linux
	objCurrentTab.Screen.Send "exit" & chr(13)
End Function
 
Function check_vc_b2
	objCurrentTab.Screen.Send "telnet 127.1 2650" & chr(13)
	objCurrentTab.Screen.WaitForString "Password:"
	objCurrentTab.Screen.Send "a" & chr(13)
	objCurrentTab.Screen.WaitForString ">"
	...
	'start to check	
	objCurrentTab.Screen.Send "!!!!!!!!!check b2" & chr(13)
	objCurrentTab.Screen.WaitForString "#"
   ...
   '******************************************
       ...
       For nIndex = 1 to crt.GetTabCount
           ...
           if objCurrentTab.Session.Connected = True then
               ...
               'Step7: do sth
   	          'count
   	          objCurrentTab.Screen.Send "### check vc - add: " & loop_op & chr(13)
   	          objCurrentTab.Screen.WaitForString  "]"
