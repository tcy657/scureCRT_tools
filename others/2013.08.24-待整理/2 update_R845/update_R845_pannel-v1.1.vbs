...
Sub Main
  ...
  End If
	...
	'Step5.1: 利用Contents保存文件目录
	'crt.Screen.Send "ll --color=never /home/bmu852/NpTar/" & chr(13)
	crt.Screen.Send "ls -l --color=never /home/bmu852/NpTar/" & chr(13)
	...
	'Step5.2: 利用 LCase 函数把大写字母转换为小写字母，所有小写字母和非字母字符保持不变。
  ...
  'for test
  crt.Screen.Send "1th " & pannel_name & chr(13)       
  crt.Screen.WaitForString "->" 
	...
	'Step7: do sth
     ...
     Case "Any"
        'copy files to panel
	      ...
	      'for test
        crt.Screen.Send "2th " & pannel_name & chr(13)       
        crt.Screen.WaitForString "->" 
