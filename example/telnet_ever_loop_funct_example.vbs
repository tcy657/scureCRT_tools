...
Function test_L3VE0
	...
	crt.Screen.WaitForString "UP BROADCAST RUNNING PROMISC MULTICAST  MTU:9720  Metric:1"
  ...
  crt.Screen.Send "ifconfig eth3 -promisc" & Chr(13)
	...
	crt.Screen.WaitForString "UP BROADCAST RUNNING MULTICAST  MTU:9720  Metric:1"   
  
  'run scuEntry.sh
  crt.Sleep 1000
  crt.Screen.Send "sh  /home/sys/netConfig.sh " & chr(13)
	crt.Screen.WaitForString ">"  
