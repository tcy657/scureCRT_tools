...
Sub Main
  ...
  xsk2(5)="vxWorks_b.bin"
	...
	'Step3: cabextract cab file
	crt.Screen.Send "ll /home/bmu852/*.cab" & chr(13)
  If crt.screen.WaitForString(".cab", 5) = True Then
  ...
  End If
	...
	Do Until pannel_flag=1  
     pannel_name = crt.Dialog.Prompt("请输入盘类型（SCUP1/E1K4/ESK4/MSK1/MSK2/MSP1/XSK2/Any/C):", _
                                  "盘类型", "SCUP1", False)
