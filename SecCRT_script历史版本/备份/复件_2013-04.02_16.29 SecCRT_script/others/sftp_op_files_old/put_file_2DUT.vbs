...
Sub Main
	...
	crt.Screen.Send "lcd d:/R845/ftp/ZEBOS" & chr(13)
  ...
  pass=30                                                                                   
   ...
   'pass = crt.Dialog.Prompt("ZEBOS.CFG NO(0~15,16):", "Enter NO", "16", True)
  pass = Inputbox("请选择待传文件(default - 16, others - 0~15, all - 17):", "文件号")
...
'        crt.Screen.Send "mv ZEBOS.CFG ZEBOS.CFG_bk" & chr(13)
      	crt.Screen.Send "put -b ZEBOS.CFG_*" & chr(13)
	      crt.Screen.WaitForString "sftp> "
   '16: put ZEBOS.CFG.
   Case "16"
        crt.Screen.Send "mv ZEBOS.CFG ZEBOS.CFG_bk" & chr(13)
   ...
   Case "15"
        ...
        crt.Screen.Send "mv ZEBOS.CFG_15 ZEBOS.CFG" & chr(13)
	      crt.Screen.WaitForString "sftp> "
   Case Else
'      msgbox " Your NO is not between 0~17! " ,, "系统提示"
	      crt.Screen.Send "put -b " & pass & chr(13) 
'        crt.Screen.Send "mv ZEBOS.CFG_15 ZEBOS.CFG" & chr(13)
	      crt.Screen.WaitForString "sftp> "
 End Select

'exit secureCRT script, look out for all sessiones exit.
