...
g_vWaitFors = Array("[root@RCU845-2 scu]", _
                    "[root@RCU845-2 nmu]", _
                    "bmu852", _
                    "Waiting for 4", _
                    "Waiting for 5", _
...
Sub Main()
    ...
    '#make sure that the remote machine is connected (added by tcy, 2012.5.12)
    ...
    Do
        '#get the disred string, return nIndex. start with 1, not 0. 
        '# (added by tcy, 2012,5,12)
